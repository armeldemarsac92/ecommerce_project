...
public class ShopProductResponse
{
   ...
   [JsonPropertyName("fruits_vegetables_legumes_estimate_from_ingredients_100g")]
   public double? FruitsVegetablesLegumesEstimateFromIngredients100G { get; set; }

   [JsonPropertyName("fruits_vegetables_legumes_estimate_from_ingredients_serving")]
   public double? FruitsVegetablesLegumesEstimateFromIngredientsServing { get; set; }

   [JsonPropertyName("fruits_vegetables_nuts_estimate_from_ingredients_100g")]
   public double? FruitsVegetablesNutsEstimateFromIngredients100G { get; set; }

   [JsonPropertyName("fruits_vegetables_nuts_estimate_from_ingredients_serving")]
   public double? FruitsVegetablesNutsEstimateFromIngredientsServing { get; set; }

   [JsonPropertyName("nova_group")]
   public int? NovaGroup { get; set; }

   [JsonPropertyName("nova_group_100g")]
   public int? NovaGroup100G { get; set; }

   [JsonPropertyName("nova_group_serving")]
   public int? NovaGroupServing { get; set; }

   [JsonPropertyName("nutrition_score_fr")]
   public int? NutritionScoreFr { get; set; }

   [JsonPropertyName("nutrition_score_fr_100g")]
   ...
   [JsonPropertyName("saturated_fat_100g")]
   public double? SaturatedFat100G { get; set; }

   [JsonPropertyName("saturated_fat_prepared")]
   public double? SaturatedFatPrepared { get; set; }

   [JsonPropertyName("saturated_fat_prepared_100g")]
   public double? SaturatedFatPrepared100G { get; set; }

   [JsonPropertyName("saturated_fat_prepared_serving")]
   public double? SaturatedFatPreparedServing { get; set; }

   [JsonPropertyName("saturated_fat_prepared_unit")]
   public string SaturatedFatPreparedUnit { get; set; }

   [JsonPropertyName("saturated_fat_prepared_value")]
   public double? SaturatedFatPreparedValue { get; set; }

   [JsonPropertyName("saturated_fat_serving")]
   public double? SaturatedFatServing { get; set; }

   [JsonPropertyName("saturated_fat_unit")]
